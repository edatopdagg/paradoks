...
gibi normal metinlerin parser'ı ilerideki clause'lara
yanlışlıkla atlatması engellenir.
"""
...
def _match_3gpp_damaged_heading(
    ...
    # "-TMSI..." extraction hasarı olabileceği için
    # yalnızca "- " şeklindeki bullet engellenir.
    if re.match(
        r"^-\s+",
        candidate,
    ):
